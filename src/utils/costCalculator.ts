...
// Credit multiplier (1 USD = 100 Credits)
const CREDIT_MULTIPLIER = 100;

// Pricing in Units (cents/credits) per image
export const PRICING = {
  "nano-banana": {
    "512": 4,   // 0.04 USD -> 4 Credits
    "1K": 4,
    "2K": 4,
    "4K": 4,
  },
  "nano-banana-pro": {
    "512": 15,  // 0.15 USD -> 15 Credits
    "1K": 15,
    "2K": 15,
    "4K": 25,
  },
  "nano-banana-2": {
    "512": 5,   // 0.05 USD -> 5 Credits
    "1K": 10,
    "2K": 15,
    "4K": 20,
  },
...
/**
 * Check whether we should hide the cost indicator.
 * Now we show it for everything unless we have ZERO nodes.
 */
export function shouldHideCost(nodes: WorkflowNode[]): boolean {
