      ...
      <div className="flex h-full w-full flex-col items-center justify-center" style={{ perspective: "1000px" }}>
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
          <motion.h1
            ...
            className="text-2xl font-black tracking-tighter text-white md:text-4xl"
          >
        ...
        >
          ...
          <p className="text-sm md:text-base text-white/40 max-w-lg leading-relaxed font-medium">
            Discover a world where technology meets creativity.{" "}
            <br className="hidden md:block" />
            Scroll through our curated collection of AI-generated innovations.
          </p>
        </motion.div>
