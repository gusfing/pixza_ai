  ...
  return (
    ...
    >
      <button onClick={handleStackHorizontally} className="btn-icon" style={{ width: 28, height: 28 }} title="Stack horizontally (H)">
        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M6 4h4v16H6zM14 4h4v16h-4z" /></svg>
      </button>
      <button onClick={handleStackVertically} className="btn-icon" style={{ width: 28, height: 28 }} title="Stack vertically (V)">
        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16v4H4zM4 14h16v4H4z" /></svg>
      </button>
      <button onClick={handleArrangeAsGrid} className="btn-icon" style={{ width: 28, height: 28 }} title="Arrange as grid (G)">
      ...
      {someInGroup ? (
        <button onClick={handleUngroup} className="btn-icon" style={{ width: 28, height: 28 }} title="Remove from group">
          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 9V4.5M9 9H4.5M9 9L3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5l5.25 5.25" /></svg>
        </button>
      ) : (
        <button onClick={handleCreateGroup} className="btn-icon" style={{ width: 28, height: 28 }} title="Create group">
      ...
      <button onClick={handleDownloadImages} className="btn-icon" style={{ width: 28, height: 28 }} title="Download images as ZIP">
