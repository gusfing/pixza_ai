...
export function buildProposalPrompt(description: string): string {
  return `You are a workflow designer for Pixza Studio, a visual node-based AI image generation tool. Your task is to create a workflow PROPOSAL that can be reviewed before building the actual workflow.
