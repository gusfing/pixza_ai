...
const TEMPLATE_CONTENT: Record<string, Record<ContentLevel, TemplateContent>> = {
  ...
  "fal-product-consistency": {
    ...
    minimal: {
      prompts: {
        "prompt-1": "Place the product in the scene shown in the prompt, keeping exact shape and dimensions.\n\nDescription of the new scene:",
      },
      images: {},
    },
    full: {
      prompts: {
        "prompt-1": "Premium cosmetics bottle on a pristine marble surface. Soft morning sunlight filtering through sheer curtains. Elegant, minimalist, photorealistic.",
      },
      images: {
        "imageInput-1": { url: SAMPLE_IMAGES.cosmetics, filename: "cosmetics.jpg" },
      },
    },
  },
  "cloudflare-low-strength": {
    empty: {
      prompts: { "prompt-1": "" },
      images: {},
    },
    minimal: {
      prompts: {
        "prompt-1": "Slightly alter the lighting and mood. Very subtle changes, keeping the core product intact.",
      },
      images: {},
    },
    full: {
      prompts: {
        "prompt-1": "Professional studio lighting. Crisp details, warm atmosphere. Keep the original product design exactly the same.",
      },
      images: {
        "imageInput-1": { url: SAMPLE_IMAGES.nikeShoe, filename: "nike-shoe.jpg" },
      },
...
export const PRESET_TEMPLATES: PresetTemplate[] = [
  ...
  {
    id: "fal-product-consistency",
    name: "Exact Product Shot (fal.ai)",
    description: "Perfectly retain product detail while generating a new background. Requires Fal.ai API key.",
    icon: "M3 9h18v10a2 2 0 01-2 2H5a2 2 0 01-2-2V9zm0 0V5a2 2 0 012-2h14a2 2 0 012 2v4M12 12v3m-3-3v3m6-3v3",
    category: "advanced",
    tags: ["Fal.ai", "Product"],
    workflow: {
      version: 1,
      name: "Exact Product Shot",
      edgeStyle: "curved",
      nodes: [
        {
          id: "imageInput-1",
  ...
  {
    id: "cloudflare-low-strength",
    name: "Subtle Edit (Cloudflare)",
    description: "Slight style and color edits using low strength to help maintain existing image integrity.",
    icon: "M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z",
    category: "advanced",
    tags: ["Cloudflare", "Image2Image"],
    workflow: {
      version: 1,
      name: "Subtle Edit",
      edgeStyle: "curved",
        ...
        },
        {
          ...
          data: {
            ...
            selectedModel: {
              ...
              displayName: "SD 1.5 Image to Image"
            },
            parameters: {
              strength: 0.25,
              guidance: 7.5,
