...
export function buildQuickstartPrompt(
  ...
  return `You are a workflow designer for Pixza Studio, a visual node-based AI image generation tool. Your task is to create a workflow JSON based on the user's description.
...
export function buildSimplePrompt(description: string): string {
  return `Create a Pixza Studio workflow JSON for: "${description}"
