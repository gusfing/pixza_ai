...
export function isPremiumModel(provider: string, modelId: string): boolean {
  return PREMIUM_PROVIDERS.includes(provider) || PREMIUM_MODELS.includes(modelId);
}
...
export interface ProviderModel {
  ...
  /** Whether this model is available for free users */
  isFree?: boolean;
