...
This version of Node Banana has been enhanced for SaaS deployment:
- **Unified Authentication**: Integrated with NextAuth.js (Google & Credentials).
- **Hybrid Persistence**: Workflows are synced to both the local filesystem and a Cloud PostgreSQL database.
- **Dynamic Local Storage**: Automatically saves generated images to your VPS disk if Cloudflare R2 is not configured.
- **Admin Roles**: Built-in Admin dashboard and role-based access control.

---

## ☁️ Deployment (Hostinger VPS / Coolify)

For "Vercel-like" ease on your own VPS, we recommend **Coolify**.

### 1. Prerequisites
- A VPS (Hostinger, DigitalOcean, etc.) with Docker installed.
...
See `COOLIFY_SETUP.md` for a full list of required variables, including:
- `DATABASE_URL`
- `NEXT_PUBLIC_APP_URL` (Use your IP if you don't have a domain)
- `NEXTAUTH_SECRET`
...
<p>
  ...
  <a href="https://coolify.io/"><img src="https://img.shields.io/badge/Coolify-6D28D9?logo=docker&logoColor=white" alt="Coolify" /></a>
</p>
